// Official SVG logos for solutions that have them.
// Each component accepts className + style props (same interface as Lucide icons).

type SvgProps = React.SVGAttributes<SVGElement> & { className?: string }

export function OpenClawLogo({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={style}>
      ...
      />
      {/* Antennas */}
      <path d="M45 15 Q35 5 30 8" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" opacity="0.7" />
      <path d="M75 15 Q85 5 90 8" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" opacity="0.7" />
      {/* Eyes */}
...
export function N8nLogo({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 48 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={style}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        fill="currentColor"
...
export function OpenWebUILogo({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" xmlns="http://www.w3.org/2000/svg" className={className} style={style}>
      <path
        clipRule="evenodd"
